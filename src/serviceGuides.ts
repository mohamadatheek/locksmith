...
export const serviceGuides: Record<string, Guide> = {
  ...
  "car-key-programming-colombo": {
    description: "Car key programming in Colombo for supported transponder keys, remotes and smart keys. Contact KeyHome in Maharagama to check vehicle compatibility.",
    sections: [
      { heading: "A cut key may still need programming", text: "A mechanical blade operates the lock, while a transponder communicates with the vehicle’s immobilizer. Remote buttons and proximity functions may require additional setup. Tell us whether the problem is starting the engine, operating the buttons or unlocking the door so we can assess the right service." },
  ...
  "car-key-replacement-colombo": {
    description: "Lost or damaged car key replacement in Colombo. KeyHome assesses compatible blades, transponders and remotes; call with your vehicle make, model and year.",
    sections: [
  ...
  "emergency-car-unlocking": {
    description: "Car door unlocking in Colombo and nearby suburbs. Call KeyHome with your location and vehicle model to confirm mobile lockout assistance availability.",
    sections: [
  ...
  "smart-key-repair": {
    description: "Smart key repair and programming in Colombo. KeyHome assesses remote buttons, casings and electronic faults for supported vehicle keys and fobs.",
    sections: [
      { heading: "Describe which functions have stopped working", text: "A remote that no longer locks the doors may still start the vehicle. A proximity key that is not detected can have a different fault from a broken casing. Tell us whether a spare works and whether the issue started after a drop, moisture exposure or a battery change." },
  ...
  "key-cutting-maharagama": {
    description: "Key cutting in the Colombo area from KeyHome in Maharagama. Car key cutting, duplication and supported general keys; call to confirm your key type.",
    sections: [
  ...
  "lock-repair-colombo": {
    description: "Car lock and ignition fault assessment in Colombo. Contact KeyHome about worn keys, sticking vehicle locks and broken keys to discuss repair options.",
    sections: [
